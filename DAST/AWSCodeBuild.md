...
phases:
  build:
    commands:
      - cd /zap/
      - python3 main.py --clientId=$SOOS_CLIENT_ID --apiKey=$SOOS_API_KEY --projectName=SOOS-DAST-AWS-CodeBuild-Test --scanMode=baseline --apiURL=https://qa-api.soos.io/api/ https://brokencrystals.com/
```
